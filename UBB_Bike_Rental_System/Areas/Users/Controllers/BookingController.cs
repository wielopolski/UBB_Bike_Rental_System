...
namespace UBB_Bike_Rental_System.Areas.Users;
    ...
    public class BookingController : Controller
{
	...
	public async Task<IActionResult> Create(BookingViewModel bookingView)
	{
		try
		{
			Booking bookingDb = _mapper.Map<Booking>(bookingView);
			bookingDb.User = User.Identity.Name;
            await _bookingRepository.Create(bookingDb);
		}
		catch
		{
